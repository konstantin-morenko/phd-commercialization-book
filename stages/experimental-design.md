...
![Доля стран в общем количестве статей](russia-science-share.png)

Доля стран в общем количестве научных статей в международных журналах
(Автор: Alpunin - собственная работа, CC BY-SA 3.0,
...
работы (НИОКР)
: метод установление цены на работы поискового, теоретического и
  экспериментального характера, выполняемые с целью создания новой
  техники.
